    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div class="border border-warning p-4 rounded">
 		...
 		<form action="/petLostReport/lostReportPetModify" method="POST" enctype="multipart/form-data" id = "frm">
            ...
            <table class="table table-bordered" style="text-align: center;">
              ...
              <thead class="thead-light">
                <tr>
                  ...
                  <td><input class="form-control" type="text" id="petRegisterNumber"  name = "petRegisterNumber" value="${reportBoardVO.petVO.petRegisterNumber}" placeholder="동물등록번호를 입력해주세요." ></td>
                </tr>
                <tr>
                  <th scope="col" class="text-center pb-3">이름</th>
                  <td><input class="form-control" type="text" id="petName" name = "petName" value="${reportBoardVO.petVO.petName}" placeholder="이름을 입력해주세요." required></td>
                </tr>
                <tr>
                ...
                <th scope="col" class="text-center pb-4">날짜</th>
                  <td>
                    <div class="form-row form-control-sm mb-3">
                      <div class="col">
                     	<input class = "custom-select d-block w-100" type = "date" name = "lostPetDate"  id = "lostPetDate" value = "${reportBoardVO.petVO.lostPetDate}" required/>
                      </div>
                    </div>
                  </td>
                </tr>
